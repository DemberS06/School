...
public class CURP_Generator extends JFrame {
    private static final String DATA_FILENAME = "9\\data.txt";
    private JTextArea outputArea;
    private JButton leerButton;
    private JButton generarButton;
    private List<Person> people = new ArrayList<>();

    public CURP_Generator() {
        super("Generador de CURP");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            CURP_Generator app = new CURP_Generator();
            app.setVisible(true);
        });
    }
