...
public class Gato {
    ...
    private int n = 3; // valor por defecto
    private char player1Char = 'X';
    private char player2Char = 'O';
    private int turno = 1; // 1 o 2
    private int movesMade = 0;

    // === Colores configurables ===
    private Color colorTextoJugador1 = Color.YELLOW;
    private Color colorTextoJugador2 = Color.YELLOW;
    private Color colorFondoVentana = Color.LIGHT_GRAY;
    private Color colorFondoBoton = Color.BLACK;
    ...
    private void createAndShowGui() {
        ...
        frame.getContentPane().setBackground(colorFondoVentana);
        ...
        boardPanel.setBackground(colorFondoVentana);
        frame.add(boardPanel, BorderLayout.CENTER);

        // Panel inferior con información de turno y reiniciar
        JPanel bottom = new JPanel(new FlowLayout(FlowLayout.CENTER));
        bottom.setBackground(colorFondoVentana);
    ...
    private void construirTablero() {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                ...
                b.setBackground(colorFondoBoton);
                final int r = i, c = j;
    ...
    private void onButtonClick(int r, int c) {
        ...
        if (!b.getText().isEmpty()) return; // ya jugado

        char marca = (turno == 1) ? player1Char : player2Char;
        b.setText(String.valueOf(marca));
        b.setForeground(turno == 1 ? colorTextoJugador1 : colorTextoJugador2);
        b.setEnabled(false);
        movesMade++;
