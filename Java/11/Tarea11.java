...
public class Tarea11 extends JFrame {
        ...
        botonLeer.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (resultado.isEmpty()) {
                    JOptionPane.showMessageDialog(Tarea11.this, "No se encontró contenido para procesar.");
                } else {
                    JOptionPane.showMessageDialog(Tarea11.this, "Texto procesado y mostrado en el área.");
                }
            }
        });
        ...
        botonGrabar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (resultado == null || resultado.isEmpty()) {
                    JOptionPane.showMessageDialog(Tarea11.this, "Primero presiona Leer para generar el texto.");
                    return;
                }
                ...
                try (BufferedWriter bw = Files.newBufferedWriter(ruta,
                    ...
                    bw.write(resultado);
                    bw.newLine();
                    JOptionPane.showMessageDialog(Tarea11.this, "Texto grabado en salida.txt");
                } catch (IOException ex) {
                    JOptionPane.showMessageDialog(Tarea11.this, "Error al escribir archivo: " + ex.getMessage());
                }
            }
        });
    }
